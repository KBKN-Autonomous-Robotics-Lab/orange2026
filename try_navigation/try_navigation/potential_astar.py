...
class PotentialAStar(Node):
    ...
    def __init__(self):
        ...
        self.obs_info = [
            ...
            [   0,      0,    0,       1,        0,        1,          0], # waypoint  0 front stop
            [   0,      0,    0,       1,        0,        1,          0], # waypoint  1 front r lane
            [   0,      0,    0,       0,        0,        1,          0], # waypoint  2 curve
            [   0,      0,    0,       0,        0,        1,          0], # waypoint  3 front barrel
            [   0,      0,    0,       0,        0,        1,          0], # waypoint  4 next barrel :lanechange
            [   0,      0,    0,       0,        0,        1,          0], # waypoint  5 front barrel
            [   0,      0,    0,       0,        0,        1,          0], # waypoint  6 next barrel :lanechange
            [   0,      0,    0,       2,        0,        1,          1], # waypoint  7 front stop
